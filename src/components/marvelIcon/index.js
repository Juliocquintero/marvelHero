...
const MarvelIcon = ({ handleReturnToHome }) => {
  return (
    <div onClick={handleReturnToHome}>
      <Link to="/">
        <svg width="130" height="52" xmlns="http://www.w3.org/2000/svg">
          <rect fill={COLORS.lowBlack} width="100%" height="100%"></rect>
          <path
            fill={COLORS.lowWithe}
          ...
          ></path>
          <path fill={COLORS.lowBlack} d="M0 0h30v52H0z"></path>
          <path
            fill={COLORS.lowWithe}
